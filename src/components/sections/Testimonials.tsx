...
const defaults: TestimonialsContent = {
  ...
  items: [
    { quote: "Mileyn turned our wedding into a film. Every detail was breathtaking — guests are still talking about it months later.", name: "Ava & Daniel", role: "Bride & Groom" },
    { quote: "The most flawless brand launch we have ever produced. Cinematic, on-brand, and executed with surgical precision.", name: "Lara Mensah", role: "CMO, Nova Studios" },
    { quote: "From the first call to the last toast, it was effortless. A truly luxurious, stress-free experience.", name: "Olivier Adebayo", role: "Private Client" },
  ],
};
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {c.items.map((t, i) => (
            ...
            >
              ...
              <p className="font-serif italic text-white/90 text-lg leading-relaxed flex-1">"{t.quote}"</p>
              <div className="mt-8 pt-6 border-t border-gold/15">
                <div className="text-white text-sm">{t.name}</div>
                <div className="text-[10px] uppercase tracking-wider-luxe text-gold mt-1">{t.role}</div>
              </div>
            </motion.div>
          ))}
        </div>
